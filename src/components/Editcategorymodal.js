...
export default function EditCategoryModal({ onClose, onCategoryEdited, type, originalName }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { success, error, isConflict } = await updateCategory(
        type,
        originalName,
        categoryName,
        token
