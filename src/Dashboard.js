        ...
        <div className="space-y-4">
          <div className="px-2 py-1">
            ...
            <div className="space-y-1">
              <button className="w-full flex items-center gap-2 px-3 py-2 text-sm rounded-lg bg-gray-100 shadow-neumorphic">
                <BarChart3 className="h-4 w-4 text-gray-600" /> {/* Adjusted icon color */}
                Dashboard
              </button>
              {/* Conditionally render History tab */}
              {user.role !== 'user' && (
                <button className="w-full flex items-center gap-2 px-3 py-2 text-sm rounded-lg bg-gray-100 shadow-neumorphic">
                  <History className="h-4 w-4 text-gray-600" /> {/* Adjusted icon color */}
                  History
                </button>
              )}
            </div>
          ...
          <div className="px-2 py-1">
            ...
            <div className="space-y-3">
              <button onClick={handleSettings} className="w-full flex items-center gap-2 px-3 py-2 text-sm rounded-lg bg-gray-100 shadow-neumorphic">
                <Settings className="h-4 w-4 text-gray-600" /> {/* Adjusted icon color */}
                Settings
              </button>
              <button
